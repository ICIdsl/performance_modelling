...
class AlexNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.features_0 = nn.Conv2d(3, 23, kernel_size=(11, 11), stride=(4, 4), padding=(2, 2))
        self.features_2 = nn.MaxPool2d(kernel_size=3, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.features_3 = nn.Conv2d(23, 68, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2))
        self.features_5 = nn.MaxPool2d(kernel_size=3, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.features_6 = nn.Conv2d(68, 146, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.features_8 = nn.Conv2d(146, 92, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.features_10 = nn.Conv2d(92, 84, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.features_12 = nn.MaxPool2d(kernel_size=3, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.avgpool = nn.AdaptiveAvgPool2d(output_size=(6, 6))
        self.classifier_1 = nn.Linear(in_features=3024, out_features=4096, bias=True)
